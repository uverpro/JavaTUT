...
// string containing the first three characters of the first string concatenated
// with the last two
// character of the second string.

// You can assume that the first argument has a length of at least
// three and the second argument has a
