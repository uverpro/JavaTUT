// Write a function `numberRange(min, max, step)` that accepts three numbers as arguments,
// `min`, `max`, and `step`.
// The function should return all numbers between `min` and `max` at `step` intervals.
