...
Math.exp(x)
// Returns Ex, where x is the argument, and E is Euler's constant
...
// and atan2() expect (and return) angles in radians.

// Since humans tend to think in degrees, and some functions (such as CSS transforms)
// can accept degrees, it is a good idea to keep functions handy that convert between the two:
...
// If we want to calculate the height of an equilateral triangle,
// and we know its side length is 100, we can use the formulae length
// of the adjacent multiplied by the tangent of the angle is equal to the opposite.
...
// We use our degToRad() function to convert 60 degrees to radians, as Math.tan()
